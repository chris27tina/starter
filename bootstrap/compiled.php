...
class Application extends Container implements HttpKernelInterface, ResponsePreparerInterface
{
    ...
    {
        return '/var/www/starter/vendor/laravel/framework/src/Illuminate/Foundation' . '/start.php';
    }
...
class PrettyPageHandler extends Handler
{
    ...
    public function handle()
    {
        ...
        if (!($resources = $this->getResourcesPath())) {
            $resources = '/var/www/starter/vendor/filp/whoops/src/Whoops/Handler' . '/../Resources';
        }
